import requests
URL = "C:\Users\82105\Downloads\weather(146)_2020-2020.csv"

with open("./weather(146)_2020-2020.csv", "w", encoding="UTF-8") as f:
...
def main():
    ...
    tavg=read_average_temper_y("hw13/weather(146)_2020-2020.csv") #리스트 값 그 자체
    tavg_y= (sum(tavg))/len(tavg)# 리스트 안 숫자

    rainfall=read_over_5mm_rain("hw13/weather(146)_2020-2020.csv")
    # 5mm이상이 몇 개 인지
    over_5mm_rainfall=len(rainfall)
                        
    total_rainfall=read_total_rainfall("hw13/weather(146)_2020-2020.csv")
